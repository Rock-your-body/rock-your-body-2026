    ...
    liffInitializing =
      (async function () {
        ...
        */
        ...
        /* -----------------------------------------------
           SYNC LINE USER TO ROCK API
           เก็บ LINE User ID (JWT sub) ที่ฝั่ง Server
        ------------------------------------------------ */
        ...
        try {
          ...
          /* Login ยังควรไปต่อได้แม้ API sync ชั่วคราวล้มเหลว */
          console.warn(
            "USER SYNC ERROR:",
            error
          );
